...
void CD3DApplication::BuildPresentParamsFromSettings()
{
    ...
    {
        m_d3dpp.Flags              = 0;
        // Changed by Ian Foley May 2004 for BasicX1. Should be removed for
        // other programs as it affects performance
...
HRESULT CD3DApplication::Render3DEnvironment()
{
    ...
    if( m_bFrameMoving || m_bSingleStep )
    {
		...
		this->m_fTimeDelta = this->m_fTime - this->m_fPreviousTime;
		this->m_fPreviousTime = this->m_fTime;
    ...
    switch( hr )
    {
        ...
        case D3DAPPERR_NOWINDOWEDHAL:
            _tcscpy( strMsg, _T("Your Direct3D hardware accelerator cannot\n")
                             ...
                             _T("Press F10 while the app is running to see a\n")
