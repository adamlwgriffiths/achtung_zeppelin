                           ...
                           bool bDrawAlphaSubsets, D3DXMATRIX* pmatWorldMatrix )
{
  ...
  // DirectX Version 9.0 has D3DX_VERSION = 0x0900 and D3DX_SDK_VERSION == 9
#if D3DX_VERSION <= 0x0901
                             ...
                             CD3DFrame* pParentFrame )
{
    ...
    if( Guid == TID_D3DRMFrame )
    {
        ...
        WideCharToMultiByte( CP_ACP, 0, (LPCWSTR)strName, -1, strAnsiName, 512, NULL, NULL );
        strName[511] = 0;
...
HRESULT CD3DFile::CreateFromResource( LPDIRECT3DDEVICE9 pd3dDevice, TCHAR* strResource, TCHAR* strType )
{
    ...
    LPXFILEENUMOBJECT pEnumObj  = NULL;
    LPXFILEDATA       pFileData = NULL;
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFile::CreateFromResource( LPDIRECT3DDEVICE9 pd3dDevice, TCHAR* strResource, TCHAR* strType )
//HRESULT CD3DFile::CreateFromResource( LPDIRECT3DDEVICE9 pd3dDevice, LPCWSTR strResource, LPCWSTR strType )
{
    ...
    WideCharToMultiByte( CP_ACP, 0, (LPCWSTR)strType, -1, strTypeAnsi, MAX_PATH, NULL, NULL );
    strTypeAnsi[MAX_PATH-1] = 0;

    WideCharToMultiByte( CP_ACP, 0, (LPCWSTR)strResource, -1, strResourceAnsi, MAX_PATH, NULL, NULL );
