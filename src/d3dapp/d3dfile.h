...
#define LPXFILE LPDIRECTXFILE
#define LPXFILEDATA LPDIRECTXFILEDATA
#define LPXFILEENUMOBJECT LPDIRECTXFILEENUMOBJECT
#else
#define LPXFILE LPD3DXFILE
#define LPXFILEDATA LPD3DXFILEDATA
#define LPXFILEENUMOBJECT LPD3DXFILEENUMOBJECT
#endif
...
public:
    ...
    HRESULT Create( LPDIRECT3DDEVICE9 pd3dDevice, LPXFILEDATA pFileData );
    HRESULT Destroy();
...
{
    HRESULT LoadMesh( LPDIRECT3DDEVICE9 pd3dDevice, LPXFILEDATA pFileData, 
                      CD3DFrame* pParentFrame );
    HRESULT LoadFrame( LPDIRECT3DDEVICE9 pd3dDevice, LPXFILEDATA pFileData, 
                       CD3DFrame* pParentFrame );
public:
    HRESULT Create( LPDIRECT3DDEVICE9 pd3dDevice, TCHAR* strFilename );
